...
#ifndef SR_REMAPPERS_SHADOWHAND_TO_CYBERGRASP_REMAPPER_H_
...
class ShadowhandToCybergraspRemapper
{
 ...
 private:
  ...
  ros::Subscriber shadowhand_jointstates_sub;
  /// publish to the cybergrasp /cybergraspforces topic
  ros::Publisher shadowhand_cybergrasp_pub;
...
#endif  // SR_REMAPPERS_SHADOWHAND_TO_CYBERGRASP_REMAPPER_H_
