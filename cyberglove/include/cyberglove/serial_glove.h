...
#ifndef CYBERGLOVE_SERIAL_GLOVE_H
#define CYBERGLOVE_SERIAL_GLOVE_H
...
public:
  /*
    ...
    */
  CybergloveSerial(std::string serial_port, std::string cyberglove_version, std::string streaming_protocol,
  ...
  /*
    ...
    */
  static const uint16_t glove_size;

  /*
    * The length of the timestamp in the 16bit protocol.
    */
  static const uint16_t timestamp_size;
...
#endif  // CYBERGLOVE_SERIAL_GLOVE_H
